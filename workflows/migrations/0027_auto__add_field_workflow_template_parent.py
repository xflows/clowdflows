...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Workflow.template_parent'
        db.add_column('workflows_workflow', 'template_parent', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['workflows.Workflow'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Workflow.template_parent'
        db.delete_column('workflows_workflow', 'template_parent_id')
    ...
    models = {
        ...
        'workflows.workflow': {
            ...
            'template_parent': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['workflows.Workflow']", 'null': 'True', 'blank': 'True'}),
