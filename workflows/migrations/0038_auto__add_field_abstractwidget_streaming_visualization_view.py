...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbstractWidget.streaming_visualization_view'
        db.add_column('workflows_abstractwidget', 'streaming_visualization_view',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AbstractWidget.streaming_visualization_view'
        db.delete_column('workflows_abstractwidget', 'streaming_visualization_view')
