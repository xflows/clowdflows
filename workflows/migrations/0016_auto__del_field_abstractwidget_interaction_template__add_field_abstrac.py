...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AbstractWidget.interaction_view'
        db.add_column('workflows_abstractwidget', 'interaction_view', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AbstractWidget.interaction_view'
        db.delete_column('workflows_abstractwidget', 'interaction_view')
