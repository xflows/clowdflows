...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbstractWidget.static_image'
        db.add_column('workflows_abstractwidget', 'static_image',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AbstractWidget.static_image'
        db.delete_column('workflows_abstractwidget', 'static_image')
