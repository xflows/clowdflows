...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AbstractWidget.user'
        db.add_column('workflows_abstractwidget', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AbstractWidget.user'
        db.delete_column('workflows_abstractwidget', 'user_id')
