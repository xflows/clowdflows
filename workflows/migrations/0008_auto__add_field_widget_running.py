...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Widget.running'
        db.add_column('workflows_widget', 'running', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Widget.running'
        db.delete_column('workflows_widget', 'running')
