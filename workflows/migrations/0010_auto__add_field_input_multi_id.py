...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Input.multi_id'
        db.add_column('workflows_input', 'multi_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Input.multi_id'
        db.delete_column('workflows_input', 'multi_id')
