...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbstractWidget.uid'
        db.add_column('workflows_abstractwidget', 'uid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'AbstractInput.uid'
        db.add_column('workflows_abstractinput', 'uid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'AbstractOutput.uid'
        db.add_column('workflows_abstractoutput', 'uid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Category.uid'
        db.add_column('workflows_category', 'uid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'AbstractOption.uid'
        db.add_column('workflows_abstractoption', 'uid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AbstractWidget.uid'
        db.delete_column('workflows_abstractwidget', 'uid')

        # Deleting field 'AbstractInput.uid'
        db.delete_column('workflows_abstractinput', 'uid')

        # Deleting field 'AbstractOutput.uid'
        db.delete_column('workflows_abstractoutput', 'uid')

        # Deleting field 'Category.uid'
        db.delete_column('workflows_category', 'uid')

        # Deleting field 'AbstractOption.uid'
        db.delete_column('workflows_abstractoption', 'uid')
