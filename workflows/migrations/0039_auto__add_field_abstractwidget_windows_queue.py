...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbstractWidget.windows_queue'
        db.add_column('workflows_abstractwidget', 'windows_queue',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AbstractWidget.windows_queue'
        db.delete_column('workflows_abstractwidget', 'windows_queue')
