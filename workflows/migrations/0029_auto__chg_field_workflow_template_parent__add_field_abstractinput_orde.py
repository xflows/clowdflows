...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Workflow.template_parent'
        db.alter_column('workflows_workflow', 'template_parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workflows.Workflow'], null=True, on_delete=models.SET_NULL))
        # Adding field 'AbstractInput.order'
        db.add_column('workflows_abstractinput', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


        # Changing field 'UserProfile.active_workflow'
        db.alter_column('workflows_userprofile', 'active_workflow_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['workflows.Workflow']))

    def backwards(self, orm):

        # Changing field 'Workflow.template_parent'
        db.alter_column('workflows_workflow', 'template_parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workflows.Workflow'], null=True))
        # Deleting field 'AbstractInput.order'
        db.delete_column('workflows_abstractinput', 'order')


        # Changing field 'UserProfile.active_workflow'
        db.alter_column('workflows_userprofile', 'active_workflow_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['workflows.Workflow']))
