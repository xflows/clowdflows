...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AbstractWidget.visualization_template'
        db.delete_column('workflows_abstractwidget', 'visualization_template')

        # Adding field 'AbstractWidget.visualization_view'
        db.add_column('workflows_abstractwidget', 'visualization_view', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'AbstractWidget.visualization_template'
        db.add_column('workflows_abstractwidget', 'visualization_template', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Deleting field 'AbstractWidget.visualization_view'
        db.delete_column('workflows_abstractwidget', 'visualization_view')
