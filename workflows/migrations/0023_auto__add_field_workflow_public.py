...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Workflow.public'
        db.add_column('workflows_workflow', 'public', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Workflow.public'
        db.delete_column('workflows_workflow', 'public')
