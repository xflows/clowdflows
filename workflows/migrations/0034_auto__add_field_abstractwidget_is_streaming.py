...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbstractWidget.is_streaming'
        db.add_column('workflows_abstractwidget', 'is_streaming',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AbstractWidget.is_streaming'
        db.delete_column('workflows_abstractwidget', 'is_streaming')
