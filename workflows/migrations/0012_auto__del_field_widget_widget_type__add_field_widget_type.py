...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Widget.type'
        db.add_column('workflows_widget', 'type', self.gf('django.db.models.fields.CharField')(default='regular', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Widget.widget_type'
        db.add_column('workflows_widget', 'widget_type', self.gf('django.db.models.fields.CharField')(default='regular', max_length=50), keep_default=False)

        # Deleting field 'Widget.type'
        db.delete_column('workflows_widget', 'type')
