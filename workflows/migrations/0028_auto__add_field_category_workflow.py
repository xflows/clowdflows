...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.workflow'
        db.add_column('workflows_category', 'workflow', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='categories', null=True, to=orm['workflows.Workflow']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.workflow'
        db.delete_column('workflows_category', 'workflow_id')
