...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Workflow.new_url'
        db.add_column('workflows_workflow', 'new_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Workflow.new_url'
        db.delete_column('workflows_workflow', 'new_url')
    ...
    models = {
        ...
        'workflows.workflow': {
            ...
            'new_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
