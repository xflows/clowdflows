...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AbstractWidget.image'
        db.add_column('workflows_abstractwidget', 'image', self.gf('workflows.thumbs.ThumbnailField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AbstractWidget.image'
        db.delete_column('workflows_abstractwidget', 'image')
