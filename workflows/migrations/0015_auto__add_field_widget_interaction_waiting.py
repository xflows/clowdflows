...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Widget.interaction_waiting'
        db.add_column('workflows_widget', 'interaction_waiting', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Widget.interaction_waiting'
        db.delete_column('workflows_widget', 'interaction_waiting')
