...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('workflows_abstractwidget', 'visualization_template', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    ...
    models = {
        ...
        'workflows.abstractwidget': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'visualization_template': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
