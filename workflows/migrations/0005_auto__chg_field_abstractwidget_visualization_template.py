...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AbstractWidget.visualization_template'
        db.alter_column('workflows_abstractwidget', 'visualization_template', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'AbstractWidget.visualization_template'
        db.alter_column('workflows_abstractwidget', 'visualization_template', self.gf('django.db.models.fields.TextField')())
