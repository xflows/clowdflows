...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbstractWidget.package'
        db.add_column('workflows_abstractwidget', 'package',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AbstractWidget.package'
        db.delete_column('workflows_abstractwidget', 'package')
