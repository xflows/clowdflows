...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Widget.finished'
        db.add_column('workflows_widget', 'finished', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Widget.finished'
        db.delete_column('workflows_widget', 'finished')
