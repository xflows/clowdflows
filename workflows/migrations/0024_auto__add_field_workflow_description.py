...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('workflows_workflow', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Workflow.description'
        db.delete_column('workflows_workflow', 'description')
