...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Widget.error'
        db.add_column('workflows_widget', 'error', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Widget.error'
        db.delete_column('workflows_widget', 'error')
