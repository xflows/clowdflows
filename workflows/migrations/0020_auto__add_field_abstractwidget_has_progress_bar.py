...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AbstractWidget.has_progress_bar'
        db.add_column('workflows_abstractwidget', 'has_progress_bar', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AbstractWidget.has_progress_bar'
        db.delete_column('workflows_abstractwidget', 'has_progress_bar')
