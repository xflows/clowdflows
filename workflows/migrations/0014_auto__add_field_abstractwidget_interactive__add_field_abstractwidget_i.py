...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AbstractWidget.interactive'
        db.add_column('workflows_abstractwidget', 'interactive', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'AbstractWidget.interaction_template'
        db.add_column('workflows_abstractwidget', 'interaction_template', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'AbstractWidget.post_interact_action'
        db.add_column('workflows_abstractwidget', 'post_interact_action', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AbstractWidget.interactive'
        db.delete_column('workflows_abstractwidget', 'interactive')

        # Deleting field 'AbstractWidget.interaction_template'
        db.delete_column('workflows_abstractwidget', 'interaction_template')

        # Deleting field 'AbstractWidget.post_interact_action'
        db.delete_column('workflows_abstractwidget', 'post_interact_action')
    ...
    models = {
        ...
        'workflows.abstractwidget': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interaction_template': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
