...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbstractWidget.order'
        db.add_column('workflows_abstractwidget', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'AbstractOutput.order'
        db.add_column('workflows_abstractoutput', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AbstractWidget.order'
        db.delete_column('workflows_abstractwidget', 'order')

        # Deleting field 'AbstractOutput.order'
        db.delete_column('workflows_abstractoutput', 'order')
