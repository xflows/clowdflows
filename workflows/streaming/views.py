...
def streaming_active_annotation(request,widget,stream):
    ...
    import pysimplesoap
    client = SoapClient(location = "http://95.87.154.167:8008/",action = 'http://batman.ijs.si:8008/',namespace = "http://example.com/tweetsentiment.wsdl",soap_ns='soap',trace = False,ns = False)
