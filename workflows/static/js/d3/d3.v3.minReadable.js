(function() {
	...
	function b(t) {
		...
		return n.on = function(n, i) {
			var u, a = r.get(n);
			return 2 > arguments.length ? a && a.on : (a && (a.on = null, e = e.slice(0, u = e.indexOf(a)).concat(e.slice(u + 1)), r.remove(n)), i && e.push(r.set(n, {
				on: i
			})), t)
		}, n
	}
	...
	function ee(t, n) {
		...
		return e.domain = function(r) {
			...
			return a = r(2 > t.length ? (c + l) / 2 : c + s * u / 2, s), o = 0, n = {
				t: "rangePoints",
				a: arguments
			}, e
			...
			return a = r(s + h * c, h), l && a.reverse(), o = h * (1 - u), n = {
				t: "rangeBands",
				a: arguments
			}, e
	...
	d3.behavior = {}, d3.behavior.drag = function() {
		...
		function n() {
			...
			function i() {
				c({
					type: "dragend"
				}), h && (R(), d3.event.target === l && d.on("click.drag", u, !0)), d.on(null != s ? "touchmove.drag-" + s : "mousemove.drag", null).on(null != s ? "touchend.drag-" + s : "mouseup.drag", null)
			}
	...
	var Wa = d3.map({
			"inside-out": function(t) {
				var n, e, r = t.length,
					i = t.map(ar),
					u = t.map(or),
					a = d3.range(r).sort(function(t, n) {
						return i[t] - i[n]
					}),
					o = 0,
					c = 0,
