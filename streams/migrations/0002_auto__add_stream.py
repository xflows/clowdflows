...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('streams_stream', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='streams', to=orm['auth.User'])),
            ('workflow', self.gf('django.db.models.fields.related.ForeignKey')(related_name='streams', to=orm['workflows.Workflow'])),
            ('last_executed', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('period', self.gf('django.db.models.fields.IntegerField')(default=60)),
        ))
